...
public class EditProfileWindow extends javax.swing.JFrame {
    ...
    public void openWindow(String email) {
        ...
        System.out.println(user.getCoverPhoto());
        ImageIcon coverIcon = new ImageIcon(user.getCoverPhoto());
        Image image = coverIcon.getImage();
        int width = (int) (jLabel2.getWidth() * 0.5);
        int height = (int) (jLabel2.getHeight() * 0.5);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            Image image = coverIcon.getImage();
            int width = (int) (jLabel1.getWidth());
            int height = (int) (jLabel1.getHeight());
            Image scaled = image.getScaledInstance(width, height, Image.SCALE_SMOOTH);
            ImageIcon scaledimage = new ImageIcon(scaled);
